...
export const seoCopy: Record<Locale, SeoCopy> = {
  en: {
    ...
    collections: {"title":"DROP 001: SIGNAL — VHOX Collection","description":"SIGNAL CORE TEE, NIGHT BLOOM TEE and CRYSTAL SIGNAL TEE are the planned pieces of DROP 001: SIGNAL. Campaign previews explore the direction; product imagery, specifications, price and release remain pending.","h1":"SIGNAL."},
    ...
    faq: [
      { question: 'Are the SIGNAL pieces available to purchase?', answer: 'Not yet. They are editorial concept studies and remain outside commerce until VHOX confirms physical samples, approved media, specifications, price and availability.' },
  ...
  es: {
    ...
    collections: {"title":"DROP 001: SIGNAL — Colección VHOX","description":"SIGNAL CORE TEE, NIGHT BLOOM TEE y CRYSTAL SIGNAL TEE son las piezas planeadas de DROP 001: SIGNAL. La campaña explora la dirección; las fotos de producto, especificaciones, precio y lanzamiento siguen pendientes.","h1":"SIGNAL."},
  ...
  pt: {
    ...
    collections: {"title":"DROP 001: SIGNAL — Coleção VHOX","description":"SIGNAL CORE TEE, NIGHT BLOOM TEE e CRYSTAL SIGNAL TEE são as peças planejadas do DROP 001: SIGNAL. A campanha explora a direção; fotos de produto, especificações, preço e lançamento seguem pendentes.","h1":"SIGNAL."},
    ...
    faq: [
      { question: 'as peças SIGNAL estão disponíveis para compra?', answer: 'Ainda não. São estudos editoriais e permanecem fora do comércio até a VHOX confirmar amostras físicas, mídia aprovada, especificações, preço e disponibilidade.' },
  ...
  fr: {
    ...
    collections: {"title":"DROP 001 : SIGNAL — Collection VHOX","description":"SIGNAL CORE TEE, NIGHT BLOOM TEE et CRYSTAL SIGNAL TEE sont les pièces prévues du DROP 001 : SIGNAL. La campagne explore la direction ; photos produit, spécifications, prix et sortie restent à confirmer.","h1":"SIGNAL."},
    ...
    faq: [
      { question: 'les pièces SIGNAL sont-ils disponibles à l’achat ?', answer: 'Pas encore. Ce sont des études éditoriales hors commerce jusqu’à confirmation des échantillons, médias approuvés, spécifications, prix et disponibilité par VHOX.' },
